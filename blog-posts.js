...
function buildNextPageUrl(nextPageUrl) {
  return `<div class="newer"><a href="${nextPageUrl}" rel="prev"><div class="blog-list-pagination-icon icon icon--stroke"><svg class="caret-left-icon--small" viewBox="0 0 9 16"><polyline fill="none" stroke-miterlimit="10" points="7.3,14.7 2.5,8 7.3,1.2 "></polyline></svg></div><span class="prev-label">Newer Posts</span></a></div>`;
}
// build navigation link
function buildPrevPageUrl(prevPageUrl){
  return `<div class="older"><a href="${prevPageUrl}" rel="next"><span class="next-label">Older Posts</span><div class="blog-list-pagination-icon icon icon--stroke"><svg class="caret-right-icon--small" viewBox="0 0 9 16"><polyline fill="none" stroke-miterlimit="10" points="1.6,1.2 6.5,7.9 1.6,14.7 "></polyline></svg></div></a></div>`;
}
// update webpage URL
